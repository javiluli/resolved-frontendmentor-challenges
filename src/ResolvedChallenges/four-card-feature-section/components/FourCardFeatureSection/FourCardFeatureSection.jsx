    ...
    <MuiContainer>
      <MuiStack sx={{ padding: ' 0 0 4em' }} direction="column" alignItems="center">
        <MuiBox sx={{ maxWidth: '35em' }}>
          <MuiTypography sx={{ color: 'text.primary', textAlign: 'center', fontWeight: 200 }} variant="h1" component="h1" gutterBottom>
      ...
      <MuiGrid container spacing={4} direction="row" justifyContent="center" alignItems="center">
        <MuiGrid item container xs={12} md={4} justifyContent="center">
          <Card title={cardsData[0].title} text={cardsData[0].text} image={cardsData[0].image} borderColor={cardsData[0].borderColor} />
        </MuiGrid>

        <MuiGrid item container xs={12} md={4} spacing={4}>
          <MuiGrid item container xs={12} justifyContent="center">
            <Card title={cardsData[1].title} text={cardsData[1].text} image={cardsData[1].image} borderColor={cardsData[1].borderColor} />
          </MuiGrid>
          <MuiGrid item container xs={12} justifyContent="center">
            <Card title={cardsData[2].title} text={cardsData[2].text} image={cardsData[2].image} borderColor={cardsData[2].borderColor} />
          </MuiGrid>
        </MuiGrid>

        <MuiGrid item container xs={12} md={4} justifyContent="center">
          <Card title={cardsData[3].title} text={cardsData[3].text} image={cardsData[3].image} borderColor={cardsData[3].borderColor} />
        </MuiGrid>
      </MuiGrid>
    </MuiContainer>
  )
