...
const ComponentAfterSubmit = ({ rating }) => {
  return (
    ...
    >
      <MuiCardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2em', padding: '0.5em' }}>
        <MuiCardMedia sx={{ width: 151 }} component="img" image={illustrationThankYou} />
