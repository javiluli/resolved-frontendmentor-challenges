      ...
      <MuiStack sx={{ px: 5, py: 2, pt: 0, height: matches ? '100%' : 'auto' }} justifyContent="center">
        <MuiBox sx={{ margin: '0 auto', maxWidth: 700 }}>
          <MuiStack sx={{ width: '100%' }} spacing={2}>
            <MuiBox sx={{ width: '100%', maxWidth: 60, display: 'block', margin: '0 auto' }} component="img" alt="Image" src={logo} />

            <MuiBox>
              <MuiTypography align="center" component="h2" gutterBottom sx={{ mb: 2, color: 'text.primary' }} variant="h5">
                We are launching
              ...
              <MuiTypography align="center" gutterBottom sx={{ fontWeight: 600, color: 'text.primary' }} variant="body1">
