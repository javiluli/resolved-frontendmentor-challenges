...
const QRCodeComponent = () => {
  return (
    <MuiBox sx={{ m: 4 }}>
      <MuiCard elevation={1} sx={{ maxWidth: 300, padding: '1em', backgroundColor: 'background.paper', borderRadius: '2em' }}>
        <MuiCardContent
          sx={{ position: 'relative', padding: '1em', backgroundColor: 'primary.main', borderRadius: '1.35em', overflow: 'hidden' }}
        >
